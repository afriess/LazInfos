...
procedure RegisterTests ;
begin
  RegisterTest( TTestFileSyncMgr ) ;
  RegisterTest( TTestFileSyncMgr_File2File);
  RegisterTest( TTestFileSyncMgr_File2Remote);
  RegisterTest( TTestFileSyncMgr_Remote2File);
end ;
