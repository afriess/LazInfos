...
unit contact_bom;
// ---------------------------------------------------------
// Automatically generated on 12.03.2017 22:36:21
// Warning: 
...
// Enumerations
  ...
  published
    ...
    property    BusinessList: TBaseBusinessList read FBusinessList;
  end;
...
begin
  ...
  GTIOPFManager.ClassDBMappingMgr.RegisterMapping(TBaseBusiness,
    'ctr_Business','Owner.OID.AsString', 'OIDContactTitle');
  GTIOPFManager.ClassDBMappingMgr.RegisterMapping(TBaseBusiness,
...
begin
  ...
  Query.ParamAsString['OIDContactTitle'] := lObj.Owner.OID.AsString;
...
begin
  ...
  lObj.Owner.OID.AsString := Query.FieldAsString['OIDContactTitle'];
