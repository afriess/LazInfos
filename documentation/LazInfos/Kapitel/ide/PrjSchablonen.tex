...
\begin{wrapfigure}{l}{0.3\textwidth}
	\includegraphics[width=0.3\textwidth]{Kapitel/ide/pics/PrjTempl01}
%	\caption{Caption1}
	\label{fig:ProjectTempl01}	
\end{wrapfigure}
Nach der Erstellung ist das Menü "`Werkzeuge"' um den Eintrag "`Optionen für Projektschablonen"' erweitert. Mit Hilfe dieses Menüpunktes kann man das Basis Verzeichnis für die Schablonen einstellen.
\begin{wrapfigure}{l}{0.3\textwidth}
	\includegraphics[width=0.3\textwidth]{Kapitel/ide/pics/PrjTempl02}
%	\caption{Caption1}
	\label{fig:ProjectTempl02}	
\end{wrapfigure}
Die Schablonen selbst befinden sich dann in den Unterverzeichnissen. Weiters wird auch das Menü "`Datei"' um den Eintrag "`Neues Projekt aus Schablone"' erweitert. Zusätzlich ist auch der "`Datei Neu .."' Dialog entsprechend erweitert.
...
\begin{wrapfigure}{l}{0.4\textwidth}
	\includegraphics[width=0.4\textwidth]{Kapitel/ide/pics/PrjTempl04}
\caption{Caption1}
\label{fig:ProjectTempl04}	
\end{wrapfigure}
Weitere Variablen, müssen in der Sektion "`[Variables]"' in der folgenden Form definiert werden. Zuerst kommt der Variablenname, dann das Gleichheitszeichen und zum Schluß eine Beschreibung, welcher in der Eingabemaske auf scheinen wird.
...
\begin{wrapfigure}{l}{0.25\textwidth}
	\includegraphics[width=0.3\textwidth]{Kapitel/ide/pics/PrjTempl05}
	%	\caption{Caption1}
